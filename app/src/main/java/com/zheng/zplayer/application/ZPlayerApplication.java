package com.zheng.zplayer.application;
...
public class ZPlayerApplication extends Application {

	private static ZPlayerApplication mApplication;
	...
	public static ZPlayerApplication getApplication() {
		return mApplication;
	}
