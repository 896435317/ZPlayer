...
public class ResideMenu extends FrameLayout {
    ...
    private ImageView mImageViewBackgroundNight;
    ...
    private void initViews(Context context, int customLeftMenuId,
        ...
        mImageViewBackgroundNight = (ImageView) findViewById(R.id.iv_background_night);
    ...
    public void setBackgroundByPath(String path){
        if(!StringUtils.isEmpty(path)){
            ...
            if(file.exists()){
           Picasso.with(ZPlayerApplication.getContext()).load(file).into(imageViewBackground);
            }
        }
    }
    ...
    public void setSkinMode(int skinMode){
        switch (skinMode){
            case ZPlayerConst.DAY_MODE :mImageViewBackgroundNight.setVisibility(View.GONE);
                break;
            case ZPlayerConst.NIGHT_MODE:mImageViewBackgroundNight.setVisibility(View.VISIBLE);
        }
    }
